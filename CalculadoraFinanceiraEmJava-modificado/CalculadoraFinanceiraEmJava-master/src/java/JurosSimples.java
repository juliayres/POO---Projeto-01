...
public class JurosSimples extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<hr>");
            out.println("<h2>Cálculo de Montante com Juros Simples</h2>");
            ...
            out.println("<br><input type='submit' name='botao' value='Calcular'/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='reset' value='Limpar'><br>");
            out.println("</form>");
            ...
            if(request.getParameter("botao") != null){
                ...
                out.println("<br><br><b>Montante= " + df.format(m));
            }             
            out.println("</b><br><br><button><a href='Home.html'>Voltar</button>");
            out.println("</body>");
            out.println("</html>");
